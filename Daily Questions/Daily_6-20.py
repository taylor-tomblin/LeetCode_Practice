...
Example 4:
Input: n = 10, restrictions = [[6,0],[5,2],[7,0],[9,1],[2,4],[3,4],[4,0],[8,2],[10,0]]
Output: 2
    ...
    def maxBuilding(self, n, restrictions):
        ...
        for i in range(1, len(restrictions)):
            ...
            if height_diff >= distance:
                max_height = max(max_height, min(curr_max, prev_max) + distance)
            else:
                remaining_distance = distance - height_diff
                max_height = max(max_height, max(curr_max, prev_max) + remaining_distance // 2)
